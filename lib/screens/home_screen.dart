...
import 'personalizar_hambur.dart'; // Importa la pantalla de personalización de hamburguesa
import 'personalizar_pizza.dart'; // Importa la pantalla de personalización de pizza
import 'personalizar_pollo.dart'; // Importa la pantalla de personalización de pollo
import 'personalizar_productox.dart'; // Importa la pantalla de otro producto a personalizar
                ...
                CustomizationOption(
                  ...
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => PersonalizarPizzaScreen()),
                    );
                  },
                ),
                CustomizationOption(
                  ...
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => PersonalizarPolloScreen()),
                    );
                  },
                ),
                CustomizationOption(
                  ...
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => PersonalizarProductoXScreen()),
                    );
                  },
                ),
              ],
      ...
      case 'Pizzas':
        products = [
          ...
          ProductCard(
              name: 'Pizza Hawaiana',
              price: 'S/.13.50',
              image: 'assets/images/pizza_hawaiana.png'),
          ProductCard(
              name: 'Pizza BBQ',
              price: 'S/.14.50',
              image: 'assets/images/pizza_bbq.png'),
        ];
        break;
      case 'Pollo':
        products = [
          ...
          ProductCard(
              name: 'Pollo BBQ',
              price: 'S/.10.50',
              image: 'lib/assets/images/pollo_bbq.png'),
          ProductCard(
              name: 'Pollo Asado',
              price: 'S/.11.00',
              image: 'lib/assets/images/pollo_asado.png'),
        ];
        break;
      default:
        products = [
